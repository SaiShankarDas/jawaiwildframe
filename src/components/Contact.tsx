...
export const Contact = () => {
  return (
    <Section id="contact" className="bg-sandstone/20">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
        <FadeIn className="space-y-8">
          <div>
            <span className="text-desert uppercase tracking-widest text-sm font-bold">Get in Touch</span>
            <h2 className="font-serif text-4xl md:text-5xl text-charcoal mt-4">Plan Your Journey</h2>
          </div>
          <p className="text-gray-600 font-light text-lg">
            Our team of travel specialists is here to help you curate your perfect wilderness escape. Reach out to us for reservations, custom itineraries, or any inquiries.
          </p>
          
          <div className="space-y-6 pt-4">
            <div className="flex items-start space-x-4">
              <MapPin className="text-deep-red mt-1" size={20} />
              <div>
                <h4 className="uppercase tracking-wider font-bold text-sm text-charcoal">Location</h4>
                <p className="text-gray-600 font-light">Jawai Bandh, Pali District, Rajasthan, India</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Phone className="text-deep-red" size={20} />
              <div>
            ...
            <div className="flex items-center space-x-4">
              <Mail className="text-deep-red" size={20} />
              <div>
                <h4 className="uppercase tracking-wider font-bold text-sm text-charcoal">Email</h4>
                <p className="text-gray-600 font-light">reservations@jawaiwildframe.com</p>
              </div>
            </div>
          </div>
        </FadeIn>

        <FadeIn delay={0.2} className="bg-white p-8 md:p-12 shadow-lg">
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea rows={4} className="w-full border-b border-gray-300 py-2 focus:outline-none focus:border-desert transition-colors bg-transparent resize-none"></textarea>
            </div>
